...
kernel_json = {
    "argv": [sys.executable, "-m", "skg_kernel", "-f", "{connection_file}"],
    "display_name": "SKG",
    "language": "python",
}
...
class CustomHook(BuildHookInterface):
    def initialize(self, version, build_data):
        ...
        prefix = os.path.join(here, 'skg_kernelspec')
        ...
        with TemporaryDirectory() as td:
            ...
            KernelSpecManager().install_kernel_spec(td, 'skg', user=False, prefix=prefix)
